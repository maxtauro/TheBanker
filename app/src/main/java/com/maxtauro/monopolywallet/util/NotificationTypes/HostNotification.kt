...
open class HostNotification(val playerId: String, val amount: Int, gameId: String, notificationType: StandardNotifications): NotificationBase(gameId, notificationType) {
